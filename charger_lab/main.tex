...
\vspace{3cm}
\title{Phone Charger (5V) From AC Power Supply}
\author{Dhruv Srikanth}
\maketitle
\tableofcontents
\renewcommand{\thetable}{\theenumi}
\bigskip
\begin{abstract}
    Lab report on the construction of a 5 V charger using a rectifier
    and a low pass analog filter.
\end{abstract}
...
\end{enumerate}
The schematic diagram of the entire circuit is shown in the figure below.
\begin{figure}[!htb]
...
bridge form as shown in the previous figure. The output waveform at this
...
Practical application of the final product is shown in the last image.
\section{Results}
...
\end{figure}
\begin{figure}[!ht]
    \includegraphics[width=\columnwidth]{figs/phone_charging.jpg}
    \caption{Mobile phone is shown to be charging when plugged in with the charger.}
    \label{fig:phone_charging}
\end{figure}
\begin{enumerate}
